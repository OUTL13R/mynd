...
export const Icons = {
  ...
  CollapseAll: () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="4 8 12 16 20 8"/><polyline points="4 4 12 12 20 4"/><line x1="4" y1="20" x2="20" y2="20"/></svg>
  ),
  Refresh: () => (
